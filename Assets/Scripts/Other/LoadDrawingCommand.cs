...
namespace Com.RogerioLima.ARPaint
{
    public class LoadDrawingCommand : MonoBehaviour, ICommand
    {
        ...
        public void Execute()
        {
            ...
            // for(int i = 1 ; i < (lp.lineStartColor.Count); i++)
            // {
            //     DrawOneLine(i,lp);
            // }
        }
        ...
        private void DrawOneLine(int i, LineProperties lp)
        {
            ...
            // if(i%2 == 0)
            // {
            //     cur_line.startColor = Color.red;
            //     cur_line.endColor = Color.red;
            // }
            // else
            // {
            //     cur_line.startColor = Color.yellow;
            //     cur_line.endColor = Color.yellow;
            // }
